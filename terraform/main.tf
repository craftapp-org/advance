        ...
        code_configuration_values {
          ...
          runtime_environment_variables = {
            ...
            runtime_environment_secrets = {
              AWS_ACCESS_KEY_ID     = "${data.aws_secretsmanager_secret_version.access_key_id.arn}:AWS_ACCESS_KEY_ID::"
              AWS_SECRET_ACCESS_KEY = "${data.aws_secretsmanager_secret_version.secret_access_key.arn}:AWS_SECRET_ACCESS_KEY::"
            }
